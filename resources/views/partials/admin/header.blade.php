        ...
        <ul class="navbar-nav ms-auto d-flex flex-row">
          ...
          <li class="nav-item">
              <a class="nav-link" href="#" id="userProfile" role="button">
                  ...
                  <img class="img-profile rounded-circle" src="https://avatars.githubusercontent.com/u/64532705?s=400&u=3521ee98229738971e694f34aeaa78f597526af8&v=4')}}" height="22">
              </a>
            </ul>
          </li>
        </ul>
